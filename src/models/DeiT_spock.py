...
class DeiT_spock(VisionTransformer):
...
def replace_block_from_origin(origin_model, load_rm_blocks, rm_blocks, LOG, args, pretrained=True, num_classes=1000, teacher=True, **kwargs: Any) -> DeiT_spock:
